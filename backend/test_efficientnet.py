"""
Test EfficientNet-B0 with Mel-Spectrogram
Much faster than AST for quick comparisons
"""
import sys
...
class EfficientNetAudio(nn.Module):
    ...
    def __init__(self, num_classes=5):
        ...
        # Replace first conv layer to accept 1 channel (mel-spec) instead of 3 (RGB)
    ...
    def forward(self, x):
        # x shape: (batch, freq, time) - mel-spectrogram
...
def main():
    print("=" * 80)
    print("TESTING EFFICIENTNET-B0 + MEL-SPECTROGRAM")
    print("=" * 80)
    ...
    model = EfficientNetAudio(num_classes=NUM_CLASSES).to(device)
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            save_path = Path(r"Y:\!_FILHARMONIA\ML_EXPERIMENTS\models\efficientnet_best.pth")
    ...
    checkpoint = torch.load(
        Path(r"Y:\!_FILHARMONIA\ML_EXPERIMENTS\models\efficientnet_best.pth")
    )
    ...
    print(f"\nModel saved to: Y:\\!_FILHARMONIA\\ML_EXPERIMENTS\\models\\efficientnet_best.pth")
    print("=" * 80)
